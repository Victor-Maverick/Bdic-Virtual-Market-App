    ...
    return (
        <div className={`flex h-[72px] ${!isLast ? 'border-b border-[#EAECF0]' : ''}`}>
            ...
            <div className="flex items-center w-[171px] px-[16px]">
                <p className="text-[14px] font-medium text-[#101828]">NGN{product.unitPrice.toLocaleString()}.00</p>
            </div>

            <div className="flex items-center w-[130px] px-[16px]">
                <p className="text-[14px] font-medium text-[#101828]">NGN{product.fee.toLocaleString()}.00</p>
            </div>
