    ...
    return(
        <>
            <div className="text-[#707070] text-[14px] px-[20px] font-medium gap-[8px] flex items-center h-[56px] w-full border-b-[0.5px] border-[#ededed]">
                ...
                <p className="cursor-pointer" onClick={()=>{router.push("/admin/dashboard/vendors")}}>Back to partners</p>
            </div>
            ...
            <div className="p-[20px] ">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex flex-col gap-[4px]">
                        <div className="flex gap-[8px] items-center">
                            <h2 className="text-[18px] font-semibold text-[#022B23]">Fele express</h2>
                        ...
                        <p className="text-[14px] text-[#707070] font-medium">View and manage partner</p>
                    </div>
                    <span className="text-[#93C51D] border-[#93C51D] border bg-[#F9FDE8] w-[72px] h-[32px] flex justify-center items-center text-[12px] rounded-[6px]">Approved</span>
                </div>
                            ...
                            <div className="flex w-full  gap-[20px] mt-[20px]  h-[86px] justify-between">
                                <div className="flex flex-col  w-[25%] rounded-[14px] h-full border-[#EAEAEA] border-[0.5px] ">
                                    <div className="w-full px-[14px] flex items-center rounded-tl-[14px] rounded-tr-[14px] h-[34px] bg-[#F7F7F7]">
                                        <p className="text-[#707070] text-[12px]">Company name</p>
                                    </div>
                                    <div className="h-[52px] flex justify-center flex-col p-[14px]">
                                        <p className="text-[20px] text-[#022B23] font-medium">Fele express</p>
                                    </div>
                                </div>
                                <div className="flex flex-col  w-[25%] rounded-[14px] h-full border-[#EAEAEA] border-[0.5px] ">
                                    <div className="w-full px-[14px] flex items-center rounded-tl-[14px] rounded-tr-[14px] h-[34px] bg-[#F7F7F7]">
                                        <p className="text-[#707070] text-[12px]">Route</p>
                                    </div>
                                    <div className="h-[52px] flex justify-center flex-col p-[14px]">
                                        <p className="text-[20px] text-[#022B23] font-medium">Makurdi</p>
                                    </div>
                                </div>
                                <div className="flex flex-col  w-[25%] rounded-[14px] h-full border-[#EAEAEA] border-[0.5px] ">
                                    <div className="w-full px-[14px] flex items-center rounded-tl-[14px] rounded-tr-[14px] h-[34px] bg-[#F7F7F7]">
                                ...
                                <div className="flex flex-col  w-[25%] rounded-[14px] h-full border-[#EAEAEA] border-[0.5px] ">
                                    <div className="w-full px-[14px] flex items-center rounded-tl-[14px] rounded-tr-[14px] h-[34px] bg-[#F7F7F7]">
                                        <p className="text-[#707070] text-[12px]">Total deliveries done</p>
                                    </div>
                                    <div className="h-[52px] flex justify-center flex-col p-[14px]">
                                        <p className="text-[20px] text-[#022B23] font-medium">361</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex w-full  gap-[20px] h-[86px] ">
                            ...
                            <div className="flex flex-col  w-[240px] rounded-[14px] h-full border-[#EAEAEA] border-[0.5px] ">
                                <div className="w-full px-[14px] flex items-center rounded-tl-[14px] rounded-tr-[14px] h-[34px] bg-[#ECFDF6]">
                                    <p className="text-[#000000] font-medium text-[12px]">CAC Number</p>
                                </div>
                ...
                <div className="flex w-[198px] gap-[6px] mt-[44px] h-[48px]">
                    <div className="flex w-[112px] text-[#022B23] font-medium justify-center h-[48px] rounded-[12px] border border-[#022B23] items-center">
                        Approve
                    </div>
                    <div className="flex w-[80px] text-[#FF5050] font-medium justify-center h-[48px] rounded-[12px] border border-[#FF5050] items-center">
                        Reject
                    </div>
                </div>
                ...
                <div className="flex flex-col mt-[50px] rounded-[24px] border-[1px] border-[#EAECF0]">
                    <div className="my-[20px] mx-[25px] flex flex-col">
                        <p className="text-[#101828] font-medium">Total deliveries</p>
                        <p className="text-[#667085] text-[14px]">View and manage all orders and deliveries</p>
                    </div>
