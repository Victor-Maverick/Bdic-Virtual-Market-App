...
// Updated MarketProductCard component to accept price as string and height/imageHeight as number
...
if (response.data.data?.authorizationUrl) {
    ...
    if (axios.isAxiosError(error)) {
        errorMessage = error.response?.data?.message || error.response?.data?.error || 'Payment service unavailable';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-[40px] px-4 sm:px-6 md:px-8 lg:px-[100px]">
            ...
            <div className="flex flex-col">
                ...
                <div className="relative mt-2 mb-4">
                    <p className="text-sm lg:text-[14px] text-gray-700 line-clamp-3">{product.description}</p>
